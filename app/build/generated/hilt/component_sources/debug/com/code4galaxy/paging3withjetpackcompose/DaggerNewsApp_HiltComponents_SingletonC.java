...
import com.code4galaxy.paging3withjetpackcompose.di.RetrofitModule_ProvideNewsRepositoryFactory;
import com.code4galaxy.paging3withjetpackcompose.di.RetrofitModule_ProvideRetrofitInstanceFactory;
import com.code4galaxy.paging3withjetpackcompose.presentation.NewsViewModel;
import com.code4galaxy.paging3withjetpackcompose.presentation.NewsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerNewsApp_HiltComponents_SingletonC {
  ...
  public static NewsApp_HiltComponents.SingletonC create() {
  ...
  private static final class ViewModelCImpl extends NewsApp_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.code4galaxy.paging3withjetpackcompose.presentation.NewsViewModel", ((Provider) newsViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.code4galaxy.paging3withjetpackcompose.presentation.NewsViewModel 
  ...
  private static final class SingletonCImpl extends NewsApp_HiltComponents.SingletonC {
    ...
    private Provider<NewsService> provideRetrofitInstanceProvider;
    ...
    private void initialize() {
      this.provideRetrofitInstanceProvider = DoubleCheck.provider(new SwitchingProvider<NewsService>(singletonCImpl, 1));
      this.provideNewsRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NewsRepository>(singletonCImpl, 0));
    }

    @Override
    public void injectNewsApp(NewsApp arg0) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.code4galaxy.paging3withjetpackcompose.data.repository.NewsRepository 
          return (T) RetrofitModule_ProvideNewsRepositoryFactory.provideNewsRepository(singletonCImpl.provideRetrofitInstanceProvider.get());

          case 1: // com.code4galaxy.paging3withjetpackcompose.data.NewsService 
          return (T) RetrofitModule_ProvideRetrofitInstanceFactory.provideRetrofitInstance();
